...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  {
    slug: "italiano-individuale-presenza",
    name: "Italiano Individuale in Presenza",
    category: "Corsi di Italiano per Stranieri",
    description: "Lezioni individuali di italiano in sede a Vicenza con docente qualificato. Percorso personalizzato su misura per le tue esigenze.",
    price: "300.00",
    priceLabel: "da",
    duration: "Pacchetti da 6 a 24 ore",
    features: [
  ...
  {
    slug: "italiano-individuale-online",
    name: "Italiano Individuale Online",
    category: "Corsi di Italiano per Stranieri",
    description: "Lezioni individuali di italiano online via Zoom con docente qualificato. Studia da qualsiasi parte del mondo.",
    price: "300.00",
    priceLabel: "da",
    duration: "Pacchetti da 6 a 24 ore",
    features: [
