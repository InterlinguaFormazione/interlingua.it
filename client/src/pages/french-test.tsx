...
export default function FrenchTestPage() {
  useSEO({
    title: "Test di Francese Gratuito Online | Livello CEFR | SkillCraft-Interlingua",
    description: "Test di livello di francese gratuito online. Valutazione adattiva CAT/IRT per scoprire il tuo livello CEFR (A1-C2) in pochi minuti. Risultati immediati.",
    canonical: "/test-di-livello/francese",
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/50 to-violet-50 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950 relative overflow-hidden notranslate" translate="no">
      <Breadcrumb items={[{ label: "Test di Livello", href: "/test-di-livello" }, { label: "Test di Francese" }]} schemaOnly />
