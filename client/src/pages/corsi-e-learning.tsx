...
const courses = [
  {
    ...
    features: [
      ...
      "Durata minima 1 mese, rinnovabile",
  ...
  },
  {
    ...
    description: "Corso blended con lezioni live con tutor madrelingua qualificati e piattaforma e-learning interattiva con strumenti avanzati come riconoscimento vocale e AI. Interazione con una community internazionale di oltre 4 milioni di studenti.",
  ...
  },
  {
    ...
    subtitle: "Sessioni 1-to-1 con madrelingua",
    description: "Sessioni di conversazione individuali con insegnanti madrelingua via Zoom, pensate per sviluppare fluency, sicurezza e padronanza della lingua in contesti reali e professionali.",
    ...
    features: [
      ...
      "Sessioni individuali via Zoom",
      "Orari flessibili",
      "Contenuti personalizzati",
      "Focus su conversazione reale",
      "Certificato a fine corso",
      "Metodo Interlingua",
    ],
    highlight: null,
