...
const allCourses: CourseData[] = [
  {
    ...
    longDescription: "I nostri corsi di lingua straniera offrono un'esperienza formativa completa con docenti qualificati. Disponibili in formato di gruppo o individuale, coprono inglese, francese, tedesco, spagnolo e russo. Con metodologia comunicativa e accesso alla piattaforma e-learning 24/7, imparerai in modo naturale ed efficace.",
    price: "Da €340",
    duration: "12 settimane",
    features: ["Docente qualificato", "Livelli QCER", "Certificato finale", "Carta Cultura"],
    category: "lingue",
  ...
  },
  {
    ...
    longDescription: "Il Language Coaching offre un percorso completamente su misura con coach qualificati. Ideale per chi ha obiettivi specifici come preparazione a colloqui, presentazioni internazionali, trasferimenti all'estero o avanzamento di carriera.",
    price: "Su richiesta",
    duration: "Personalizzata",
    ...
    categoryTitle: "Lingue e Interculturalità",
    categoryColor: "from-purple-500 to-purple-600",
    includes: ["Sessioni one-to-one con coach qualificato", "Piano formativo personalizzato", "Materiale su misura", "Flessibilità totale su orari e contenuti", "Report periodici sui progressi", "Supporto tra le sessioni"],
    requirements: ["Nessun requisito particolare"],
  ...
  },
  {
    ...
    longDescription: "Le Learning Week e i Weekend Tematici offrono esperienze formative immersive e intensive. Dedicati a temi specifici come business english, conversazione avanzata o preparazione esami, permettono di fare progressi significativi in poco tempo con docenti qualificati.",
    price: "Da €750",
    duration: "5-7 giorni",
    features: ["Full immersion", "Docenti qualificati", "Approccio esperienziale", "Certificato QCER"],
    category: "lingue",
    categoryTitle: "Lingue e Interculturalità",
    categoryColor: "from-purple-500 to-purple-600",
    includes: ["Programma intensivo full day", "Docenti qualificati e specializzati", "Materiale didattico completo", "Attività esperienziali", "Certificato di avanzamento QCER", "Convenzioni alloggio"],
  ...
  },
  {
    ...
    longDescription: "La Full Immersion English è un workshop superintensivo finalizzato all'avanzamento di un intero livello QCER in una sola settimana. Condotto da 4 formatori/coach specializzati in linguaggio specialistico, grammatica, Soft Skills, Small Talk, Ear Training e Game-Based-Learning, presso la sede di Vicenza centro storico, patrimonio UNESCO.",
    price: "Da €750",
    duration: "5-7 giorni",
    features: ["4 coach qualificati", "Vicenza centro", "Soft skills", "Certificato QCER"],
    category: "formazione-esperienziale",
    categoryTitle: "Formazione Esperienziale",
    categoryColor: "from-green-500 to-green-600",
    includes: ["Workshop superintensivo indoor", "4 formatori specializzati", "Linguaggio specialistico customizzato", "Soft Skills e Small Talk", "Game-Based-Learning", "Certificato avanzamento QCER", "Convenzioni hotel/b&b Vicenza"],
  ...
  },
  {
    ...
    categoryTitle: "Formazione Esperienziale",
    categoryColor: "from-green-500 to-green-600",
    includes: ["Soggiorno centro equestre", "Attività con i cavalli", "Adventure trail nel bosco", "Workshop Leadership e Team Building", "Coach qualificato", "Tutti i pasti", "Materiali e attrezzature"],
