...
const CEFR_DESCRIPTIONS: Record<string, { label: string; desc: string }> = {
  A1: { label: "A1 - Beginner", desc: "I can understand basic business greetings and read simple workplace signs and labels." },
  A2: { label: "A2 - Elementary", desc: "I can handle simple business interactions, write short emails, and understand basic meeting agendas." },
  B1: { label: "B1 - Intermediate", desc: "I can participate in routine business meetings, write standard business correspondence, and understand main points of reports." },
  B2: { label: "B2 - Upper Intermediate", desc: "I can contribute actively to business discussions, draft detailed reports, and handle negotiations on familiar topics." },
  C1: { label: "C1 - Advanced", desc: "I can lead complex business negotiations, present strategic proposals persuasively, and produce well-structured executive reports." },
};
        ...
        {(phase === "registration" || phase === "self-assessment") && (
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 dark:from-white dark:via-blue-100 dark:to-indigo-200 bg-clip-text text-transparent leading-tight" data-testid="text-page-title">
              Test Your Business<br className="hidden md:block" /> English Level
            </h1>
            <p className="text-slate-500 dark:text-slate-400 mt-3 text-base max-w-lg mx-auto">
              An adaptive placement test that evaluates your professional English across grammar, vocabulary, reading, listening, writing, and speaking.
            </p>
          </div>
        )}
        {phase !== "registration" && phase !== "self-assessment" && (
