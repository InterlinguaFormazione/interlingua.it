...
export default function BusinessEnglishTestPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50/50 to-orange-50 dark:from-slate-900 dark:via-amber-950 dark:to-orange-950 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-amber-200/30 dark:bg-amber-800/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 -left-32 w-80 h-80 bg-orange-200/25 dark:bg-orange-800/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 right-1/4 w-72 h-72 bg-amber-100/20 dark:bg-amber-800/10 rounded-full blur-3xl" />
      </div>
        ...
        {(phase === "registration" || phase === "self-assessment") && (
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 dark:from-white dark:via-blue-100 dark:to-indigo-200 bg-clip-text text-transparent leading-tight" data-testid="text-page-title">
              Scopri il Tuo Livello<br className="hidden md:block" /> di Business English
            </h1>
            <p className="text-slate-500 dark:text-slate-400 mt-3 text-base max-w-lg mx-auto">
              Un test rapido e adattivo per valutare le tue competenze di inglese professionale e aziendale.
            </p>
          </div>
        )}
        {phase !== "registration" && phase !== "self-assessment" && (
          ...
          <div className="max-w-xl mx-auto" data-testid="card-registration">
            <div className="grid grid-cols-3 gap-4 mb-8 max-w-sm mx-auto">
              ...
              <div className="flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/50 dark:bg-slate-800/40 backdrop-blur-sm border border-white/80 dark:border-slate-700/50">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400 text-center">~10 min</span>
              </div>
            </div>
