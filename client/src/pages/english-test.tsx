...
export default function EnglishTestPage() {
  useSEO({
    title: "Test di Inglese Gratuito Online | Livello CEFR | SkillCraft-Interlingua",
    description: "Test di livello di inglese gratuito online. Valutazione adattiva CAT/IRT per scoprire il tuo livello CEFR (A1-C2) in pochi minuti. Risultati immediati.",
    canonical: "/test-di-livello/inglese",
  });
  ...
  useEffect(() => {
    const activePhases = ["mc-questions", "writing", "speaking"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/50 to-violet-50 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950 relative overflow-hidden notranslate" translate="no">
      <Breadcrumb items={[{ label: "Test di Livello", href: "/test-di-livello" }, { label: "Test di Inglese" }]} schemaOnly />
            ...
            <div className="rounded-3xl bg-white/80 dark:bg-slate-800/70 backdrop-blur-xl border border-white/90 dark:border-slate-700/60 shadow-2xl shadow-blue-900/5 dark:shadow-black/20 overflow-hidden">
              <div className="px-8 pt-8 pb-4 text-center">
                ...
                <p className="text-amber-600 dark:text-amber-400 text-xs mt-4 max-w-sm mx-auto">
                  Per una valutazione più accurata, ti consigliamo di fare il test con audio e microfono attivi.
                </p>
                <button
                  onClick={() => {
